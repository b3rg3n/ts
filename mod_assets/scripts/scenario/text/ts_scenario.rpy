label ts_scenario_0:
    ...
    ts_ft "С завтрашнего дня у тебя будет новая жизнь в новой школе."
    ...
    nvlbazar "{font=[ts_nvl_font2]}Милли была немного старше меня, но мы с ней как будто были на одной волне."
    ...
    hide zatemnenie
    nvlbazar "{font=[ts_nvl_font2]}У Миры была ещё старшая сестра, однако сестра эта была от другого брака, поэтому они были так непохожи друг на друга."
    ...
    nvlbazar "{font=[ts_nvl_font2]}Но затем в новом учебном году к нам в школу пришла {i}она{/i}."
    ...
    show kaori 23c at t11
    nvlbazar "{font=[ts_nvl_font2]}Каори была очень открытым человеком. Я же, наоборот, старалась закрыться ото всех."
    ...
    nvlbazar "{font=[ts_nvl_font2]}«Ура-а-а, достижение, у тебя был хоть кто-то, кто о тебе заботился.»"
    nvl clear
    ...
    nvlbazar "{font=[ts_nvl_font2]}Все эти дебюты, эндшпильные теории и всё такое прочее – всё это было… завораживающим."
    ...
    nvlbazar "{font=[ts_nvl_font2]}Я же знаю, что так-то оно так, только руки у меня не из того места растут…"
    ...
    nvlbazar "{font=[ts_nvl_font2]}«Ну как же ты не понимаешь, что я же, по сути, точно такая же, как и ты?»"
