label ts_scenario_2:
    ...
    s "Ещё я узнала, что она не состоит ни в каком клубе, и сказала, что если она любит читать, то в Литературном клубе ей всегда рады!"
    ...
    "Дальше я уже не слушаю. Экзюпери. Я её как-то читала в детстве, и мы проходили Принца на уроках мировой литературы."
    ...
    "Можно сделать её моей своеобразной фишкой."
...
#ТУТ БУДЕТ ЦГШКА (ЭТИМ ЗАНИМАТЬСЯ БУДЕМ НЕ МЫ, А СПЕЦИАЛЬНЫЙ ЧЕЛОВЕЧЕК, ЕСЛИ ЧТО)
    ...
    if persistent.cens_mode == True:
        ...
        y "Что я просто ненормальная с коллекцией ножей..."
    ...
    "Мне и своих волос хватает, но если можно, я бы хотела отрастить такие же волосы, как у неё."
