label ts_scenario_5:
    ...
    m "Да, {i}Аки{/i}, так вот... Что ты имела в виду под «циклами»?"
    em 1bi "Ну..."
    ...
    menu:
        "Играть в шахматы":
            ...
            if chess_tutor == True:
                ...
                cm 2d "Однако, есть большое количество этюдов и задачек, которые как раз построены на том, чтобы превратить пешку в фигуру более низкого достоинства. Например, в коня или ладью."
                $ TS.Screens(ts_hidescreens)
                " {w=1.0}{nw}"
                show monika at ron44
                pause 0.5
            ...
            nvlbazar "{font=[ts_nvl_font2]}Иногда, как бы ты ни старалась, победить соперника ну никак не получается."
