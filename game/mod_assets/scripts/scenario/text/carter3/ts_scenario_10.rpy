label ts_scenario_10:
    ...
    "В любом случае, мы оба сделали вид, что это самая обычная суббота."
    ...
    extend " Думал о том, как бы мне убить тебя, спрятать тело, а затем и себя убить заодно."
    ...
    m "Ага... поговори мне тут... ты же и сама видела, что безумный папа, который хотел оторвать мне уши, был очень даже настоящим!"
    ...
    "Слово в слово."
    "Иногда, когда учитель делает паузы (тоже в одних и тех же местах, что и в прошлый раз), я про себя сама договаривала конец фразы."
    ...
    em "Она и без того уже сотни раз полетела ко всем чертям, хуже уже точно не будет."
    show yuri 1j at f31
