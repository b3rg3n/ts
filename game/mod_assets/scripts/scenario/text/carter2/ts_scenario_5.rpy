...
#hide sayori
#play music m1
#флешбек из первого акта, только здесь будет одна только черешня, без остальных докичей
...
#виндоу хайд на пару секунд
    ...
    m "{size=+40}{b}А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А-А{/b}{/size}{nw}" #и шрифт какой-то максимально уродский сделай

    "Крик постепенно переходит в бесконтрольное рыдание."

    m "{size=+20}{b}ПРОСТИПРОСТИПРОСТИПРОСТИПРОСТИПРОСТИ{/b}{/size}{nw}" #тем же шрифтом
...
centered "Да что же это такое? Я же буквально источник всех проблем!" #vivaldi
centered "Мало того, что напилась в стельку вчера, так ещё и с утра довела и себя, и свою подругу, до истерики!" #vivaldi
centered "Посмотрим, как ты запоёшь через пару циклов..." #adventure
centered "Циклов?.." #vivaldi
centered "Да так... неважно... потом поймёшь..." #adventure
centered "ЧТО ТЫ ЗНАЕШЬ? ОТВЕЧАЙ!" #vivaldi

#как-то плавненько обратно на реальность
