# ШЕЙДЕР КАПЕЛЬ НА СТЕКЛЕ
# ВЗЯЛ С САЙТА shadertoy
# ИМЕЙ В ВИДУ, БЛЯТЬ - БГ ПЕРЕВОРАЧИВАЕТСЯ ПРИ ИСПОЛЬЗОВАНИИ ЧЕРЕЗ ЭТОТ ШЕЙДЕР
# ТАК ЧТО... ОН ИЗНАЧАЛЬНО ДОЛЖЕН БЫТЬ ПЕРЕВЁРНУТЫМ
# АГА?
init python:
