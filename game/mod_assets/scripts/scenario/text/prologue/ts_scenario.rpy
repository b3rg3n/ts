label ts_scenario_0:
    ...
    nvlbazar "{font=[prologue_font]}Однако, оглядываясь назад, я понимаю: что-то одарённое во мне действительно было."
    ...
    nvlbazar "{font=[prologue_font]}Или, может, это была пресловутая жадность учителей, которым захотелось поднять лёгких денег на «глупой Монике». Этого я уже точно не знаю."
    ...
    nvlbazar "{font=[prologue_font]}Друзей и подруг у меня не было."
    nvlbazar "{font=[prologue_font]}Хотя нет, была одна. Звали её Мира."
    ...
    nvlbazar "{font=[prologue_font]}У неё была ещё старшая сестра, однако сестра эта была от другого брака, да и она была намного старше нас с Мирой."
    ...
    nvlbazar "{font=[prologue_font]}Но и там, когда Мира находила новых друзей и подруг, они как бы невзначай забывали про меня."
    ...
    nvlbazar "{font=[prologue_font]}Мысли о том, что если с первого раза я не добилась особых успехов, то оно мне и в целом не нужно."
    nvl clear
    ...
    nvlbazar "{font=[adv_font]}И порой это даже и к лучшему. Вспомни хотя бы, как ты пересилила себя, и организовала себе подработку спасателем на лето в прошлом году."
    nvlbazar "{font=[adv_font]}Если бы не я, то ты бы даже и не попыталась, и всё лето просидела бы на одном месте."
    nvl clear

    nvlbazar "{font=[prologue_font]}Впрочем, мы не о подработке говорим, а о жизни. Поэтому {i}пожалуйста{/i}, не мешай."
    show kaori 21o at h11
    nvlbazar "{font=[prologue_font]}Почему у меня «был» друг детства? Потому что после нескольких лет чистой и искренней дружбы Каори перевели в другую школу. А я снова осталась одна."
    ...
    nvlbazar "{font=[prologue_font]}Я же, в свою очередь, хотя и была прилежной ученицей, и до сих пор остаюсь отличницей, внутри была лентяйкой, каких только поискать надо."
    ...
    nvlbazar "{font=[prologue_font]}Помимо этого, я уже много лет занималась настольным теннисом, и даже многократно ездила на соревнования по городу."
    ...
    nvlbazar "{font=[prologue_font]}Однако, как говорится, внешность бывает очень обманчива. Сама я знаю, что хоть и я умею многое, но я всё умею плохо."
