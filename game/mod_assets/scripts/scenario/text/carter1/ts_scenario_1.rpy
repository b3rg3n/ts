label ts_scenario_1:
    ...
    show sayori 3f at t11
    m "Ну, в этом-то и суть нашего собрания - придумать и другие способы привлечения!"
    ...
    "Сказать честно - я не знаю, как это отличается от тех же листовок."
    "Если это вообще отличается..."
    "ну да и пусть - эту идею всё равно предложила Сайори. Аргументировала она это тем, что большой плакат будет всё-таки красочнее, чем какие-то бездушные и бесцветные листовки."
    ...
    "Всё это время она с абсолютным безразличием и пустым взглядом стоит в дальнем конце коридора, недалеко от туалетов."
    "Что же, уже радует."
    "Я перехожу на гораздо более тихий голос, чтобы не спугнуть ни учителей, ни учеников, ни саму Сайори."

    m "{size=-6}Сайори, я же отчётливо вижу, что что-то не так. Да что там, всё не так! Что вообще случилось?{/size}"
    ...
    m "А сильные люди не сдаются на полпути. Мы разовьём этот клуб."
    m "Обязательно."
    ...
    "Впрочем, думаю я слишком недолго, потому что уже начинает темнеть."
    ...
    ts_ft "Это хорошо..."
    show hiroto 2e at f11
    "Я сознательно не рассказываю о том, что Сайори не понимает, зачем ей вообще жить и существовать."
    ...
    "Как для мужчины, который попросту не до конца знает обо {b}всех{/b} тонкостях, таких как, например, матка и менструация, он был довольно хорош."
    ...
    "Хорошо хоть не забыла рассказать мне об этом..."
