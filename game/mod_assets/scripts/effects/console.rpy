...
#    pause 1
#    $ consolehistory = []
#    call updateconsole ("os.open(\"source/music/mutter.ogg\")", "Запущен трек Rammstein - Mutter (piano cover).") from _call_updateconsole_8
#    play music mutter fadein 2
#    pause 1.0
#    call updateconsole ("os.open(\"source/cg/mon_piano.jpg\")", "Изображение mon_piano.jpg успешно открыто.") from _call_updateconsole_9
#    pause 1.0
#    hide console_bg
#    hide console_caret
#    hide ctext
