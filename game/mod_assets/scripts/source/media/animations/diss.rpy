...
###ТРАНЗИТЫ IMAGE
    ...
    define diam = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/pattern.webp"), 1.1, 1) # КРИСТАЛЛ
    define fdiam = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/pattern.webp"), 0.4, 1) # КРИСТАЛЛ
    define fulldiam = MultipleTransition([False,fdiam,("mod_assets/source/images/anim/digi1.webp"),fdiam,True]) # КРИСТАЛЛ
    define gopr = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/blackout_go.webp"), 0.95, 1) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define gopr2 = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/blackout_go.webp"), 1.4, 1) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define clock_l = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/clock_l.webp"), 0.95, 1) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define joff_l = MultipleTransition([False, clock_l, Solid("#000"), clock_l, True]) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define clock_r = ImageDissolve(("mod_assets/source/images/anim/transit/clock_r.webp"), 2.5, 50, reverse=False) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define joff_r = MultipleTransition([False, clock_r, Solid("#000"), clock_r, True]) # ПОВОРОТНЫЙ ПЕРЕКЛЮЧАТЕЛЬ
    define blind_d = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/roof_ks.webp"), 1.3) # Жалюзи а ля KS
    define blinds_l = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/roof_ks2.webp"), 0.6) # Жалюзи а ля KS
    define blinds_r = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/roof_ks3.webp"), 0.7) # Жалюзи а ля KS
    define blinds_ud = ImageDissolve(("mod_assets/source/images/anim/transit/blackout_ud.webp"), 0.3) # Жалюзи а ля KS
    ...
    define touch = ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/pattern2.webp"), 0.9, 1) # РАЗНОЕ
    define dspq = Dissolve(0.04, alpha=True) # РАЗНОЕ
    define dsps = Dissolve(3.0, alpha=True) # РАЗНОЕ
    define guess_on = ImageDissolve(("mod_assets/source/images/anim/transit/blackpalm.webp"), 0.25, ramplen=256, reverse=True) # РАЗНОЕ
    define guess_off = ImageDissolve(("mod_assets/source/images/anim/transit/blackpalm.webp"), 0.3, ramplen=256) # РАЗНОЕ
