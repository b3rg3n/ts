...
screen pizda_text6:
    text "{size=+15}{font=[adv_font]}Ну, или не совсем. Они все убили себя сами. Но довела их до такого состояния не кто иной, как ты.{/font}{/size}" yalign 0.5 xalign 0.5

screen pizda_text7:
    text "{size=+15}{font=[adv_font]}У Сайори была депрессия. И именно ты угнетала её вплоть до того, что как-то раз утром она связала себе петлю и сдёрнула себя со стула.{/font}{/size}" yalign 0.5 xalign 0.5
