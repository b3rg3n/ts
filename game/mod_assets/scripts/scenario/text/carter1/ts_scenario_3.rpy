label ts_scenario_3:
    ...
    "Я имею в виду, вот же Сайори обрадуется, если я скажу Юри, что у Сайори депрессия, не сказав при этом о том, что у Юри, в свою очередь, мания навредить себе!"
    "Или наоборот..."
    ...
    "Даже с учётом того, что у меня ещё Литературный клуб, и приду я поздно, как обычно, папа, по всей видимости, насыпал хлопьев от души, так что я до сих пор не проголодалась."
    ...
    "Куда делось «в своём клубе я хочу, чтобы не было слова 'неправильно'»?"
    "Куда делось «в своём клубе каждый может выражаться, как его душе может быть угодно»?"
    ...
    n 1k "Ты же мне так и не сказала, когда и куда приходить, поэтому я подождала рядом у кабинета."
    ...
    m "Ну, не всё же тебе отдуваться за мой клуб, нужно и мне как {b}президенту клуба{/b} как-то посодействовать."
