label ts_scenario_5:
    ...
    "Однако вполне логично, что Юри и Сайори - два {i}совершенно{/i} разных человека."
    "К тому же, одну я просто выслушивала, а второй я сама сказала, что она повесится."
    ...
    m "Да, так вот... Что ты имела в виду под «циклами»?"
    em 1bi "Ну..."
    ...
    menu:
        "Сказать правду":
            ...
            m "Например, как Юри и Сайори тащили меня...{w=0.44} а точнее, мою «тушку», как она выразилась...{w=0.44} со школы аж до самого её дома."
    ...
    ts_ft 1c "Поэтому я позавтракал, умылся немного посмотрел телевизор, а затем вспомнил о машине, ну и начал с ней возиться."
    ...
    nvlbazar "{font=[ts_nvl_font2]}Родители неоднократно спрашивали меня на тему того, чтобы водить машину, но я им отвечала, что «буду важной, буду богатой - будет у меня свой водитель, который и будет водить вместо меня. А мне самой это не нужно.»"
    ...
    menu:
        "Играть в шахматы":
            ...
            if chess_tutor == True:
                ...
                show momika 3i at t44
                cm "Номинально слон и конь стоят одинаково, по три очка. Однако, считается, что слон немного, но лучше коня, потому что он дальнобойный."
                show momika 3l at t44
            ...
            if chess_tutor == True:
                ...
                show momika 4b at t44
                cm "Есть несколько вариантов защититься от шаха: либо походить самим королём, либо перекрыть клетку, по которой его «простреливают», либо просто съесть саму фигуру, которая объявила шах."
    ...
    em 2bd "Знаю."
    em 2bk "Это же, по сути, то, чем ты и занимаешься на протяжении..."
    ...
    em 2bd "Эй-эй. У тебя не раздвоение, и не шизофрения. Я всего лишь твоё подсознание."
