label ts_scenario_0:
    ...
    nvlbazar "{font=[prologue_font]}Поэтому ни о какой дружбе между нами не могло быть и речи. Уважать друг друга – да. Дружить – уж извольте."
    ...
    nvlbazar "{font=[prologue_font]}Однако внешность бывает очень обманчива. Сама я знаю, что хоть я и умею многое, но всё – плохо."
