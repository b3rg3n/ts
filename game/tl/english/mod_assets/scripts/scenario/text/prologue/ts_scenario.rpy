...
translate english ts_scenario_0_b7540345:
    ...
    nvlbazar "{font=[prologue_font]}But of course, it all started in a completely different way..."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:45
translate english ts_scenario_0_4e9f13d2:
    ...
    nvlbazar "{font=[prologue_font]}My life started just like everyone else's: I was born, went to school, graduated... Well, not yet, but still."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:46
translate english ts_scenario_0_c311e19b:

    # nvlbazar "{font=[prologue_font]}С самого детства взрослые называли меня «одарённой девочкой»."
    nvlbazar "{font=[prologue_font]}And ever since the childhood others have been calling me 'a gifted girl'."
...
translate english ts_scenario_0_65ffab78:
    ...
    nvlbazar "{font=[prologue_font]}In my early years I didn't know what's so 'gifted' about me, but, as the saying goes, who am I to question the adults?"
...
translate english ts_scenario_0_7fe21dbb:
    ...
    nvlbazar "{font=[prologue_font]}'You're still too young yet'... 'You haven't grown up enough yet'... 'You'll grow up and you'll understand'... The list goes on and on..."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:50
translate english ts_scenario_0_cc0b865e:

    # nvl clear
    # nvlbazar "{font=[prologue_font]}Однако, оглядываясь назад, я поняла: что-то одарённое во мне\nдействительно было."
    nvl clear
    nvlbazar "{font=[prologue_font]}But, looking back, I understand: there {b}is{/b} something gifted about me."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:54
translate english ts_scenario_0_4b97c5a2:

    # nvl clear
    # nvlbazar "{font=[prologue_font]}В три года я научилась читать. К пяти годам я уже знала всю базовую таблицу умножения."
    nvl clear
    nvlbazar "{font=[prologue_font]}I learned how to read at the age of three. By the age of five I already knew all basic multiplication table."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:59
translate english ts_scenario_0_e1a00ff4:

    # nvlbazar " {w=1.0}{nw}"
    nvlbazar " {w=1.0}{nw}"

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:61
translate english ts_scenario_0_76b2fe88:

    # nvl clear
    nvl clear

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:74
translate english ts_scenario_0_2065d4a5:

    # nvlbazar "{font=[prologue_font]}Дальше, уже в школе, пока остальные до сих пор учили буквы, я уже невообразимо быстро читала."
    nvlbazar "{font=[prologue_font]}Later on, at school, while others were still learning letters, I had already read quite fast."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:75
translate english ts_scenario_0_678f68f7:
    ...
    nvlbazar "{font=[prologue_font]}And while others were still how to add two by two, I could multiply two-digit numbers without a calculator."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:76
translate english ts_scenario_0_e65be8b2:
    ...
    nvlbazar "{font=[prologue_font]}And it quickly got boring: while others were actually learning something, I was just daydreaming."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:78
translate english ts_scenario_0_e7e7dbf9:

    # nvl clear
    # nvlbazar "{font=[prologue_font]}Потому что я уже всё это знала."
    nvl clear
    nvlbazar "{font=[prologue_font]}Because I had already known that."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:82
translate english ts_scenario_0_1bdce3a3:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}But teachers thought that I was daydreaming not because I knew much more than usual first-grader, but because I was that dumb."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:85
translate english ts_scenario_0_04d5da45:
    ...
    nvlbazar "{font=[prologue_font]}Or maybe it was merely teachers' greed who wanted to make easy money on 'dumb Monika'. That I don't know for sure, and can't know for that matter."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:86
translate english ts_scenario_0_1e105b62:
    ...
    nvlbazar "{font=[prologue_font]}Anyway, after yet another parent-teacher meeting in which I was oppressed and belittled apparently, my dad just had enough of it."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:87
translate english ts_scenario_0_3086d504:

    # nvlbazar "{font=[prologue_font]}И отдал меня в другую, специализированную школу."
    nvlbazar "{font=[prologue_font]}And took me to another, specialized school."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:90
translate english ts_scenario_0_e1a00ff4_1:

    # nvlbazar " {w=1.0}{nw}"
    nvlbazar " {w=1.0}{nw}"

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:92
translate english ts_scenario_0_76b2fe88_1:

    # nvl clear
    nvl clear

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:107
translate english ts_scenario_0_46c886cc:

    # ts_ft "Хочешь в школу к Мире?"
    ts_ft "Wanna go to school to Mira?"

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:112
translate english ts_scenario_0_f728e787:
...
translate english ts_scenario_0_314e691b:
    ...
    ts_ft 1b "Then say goodbye to this school."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:114
translate english ts_scenario_0_99be49ae:

    # ts_ft "С завтрашнего дня у тебя будет новая жизнь в {i}новой{/i} школе."
    ts_ft "Tomorrow you'll have a new life in a {i}new{/i} school."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:119
translate english ts_scenario_0_db5a6667:

    # m "До свидания, школа!"
    m "Goodbye, school!"

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:122
translate english ts_scenario_0_c414ec17:
...
translate english ts_scenario_0_bf40c9f6:
    ...
    nvlbazar "{font=[prologue_font]}No, I'm not calling myself a genius, even though I did much better than other kids of my age."
...
translate english ts_scenario_0_9701f949:
    ...
    nvlbazar "{font=[prologue_font]}But besides reading, multiplication table and other stuff so important in grade school and so useless in everything else..."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:132
translate english ts_scenario_0_eb6b1f90:

    # nvlbazar "{font=[prologue_font]}Я совершенно не знала, как взаимодействовать с людьми."
    nvlbazar "{font=[prologue_font]}I completely didn't know how to interact with people."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:133
translate english ts_scenario_0_44c3cd43:

    # nvlbazar "{font=[prologue_font]}Друзей и подруг можно пересчитать по пальцам одной руки."
    nvlbazar "{font=[prologue_font]}My friends can be counted on one hand's fingers."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:135
translate english ts_scenario_0_601c0b70:

    # nvlbazar "{font=[prologue_font]}Сначала у меня была одна подружка. Звали её Мира."
    nvlbazar "{font=[prologue_font]}At first I had a friend called Mira."
...
translate english ts_scenario_0_5f412b61:
    ...
    nvlbazar "{font=[prologue_font]}Our families were close friends at the time, and so were us."
...
translate english ts_scenario_0_642cd9b5:
    ...
    nvlbazar "{font=[prologue_font]}Mira was a bit older than me, but me and her were like on the same page."
...
translate english ts_scenario_0_59b634b1:
    ...
    nvlbazar "{font=[prologue_font]}And that's why there wasn't even any talk about friendship. Respect each other - yes. Be friends - no thanks."
...
translate english ts_scenario_0_aca31b67:
    ...
    nvlbazar "{font=[prologue_font]}But as soon as I turned up to school with Mira, she kind of moved away from me."
...
translate english ts_scenario_0_8fb677c7:
    ...
    nvlbazar "{font=[prologue_font]}Turns out that Mira had her own friends who grew up with her on the same street, and those friends looked down on 'some strange girl'."
...
translate english ts_scenario_0_689d07c9:
    ...
    nvlbazar "{font=[prologue_font]}But mostly they just looked at me like at a blank space."
...
translate english ts_scenario_0_397798cf:
    ...
    nvlbazar "{font=[prologue_font]}We still were friends outside of school. We still played together, and when we grew a bit older, we went to the same summer camp several times."
...
translate english ts_scenario_0_aa58ba08:
    ...
    nvlbazar "{font=[prologue_font]}But even there Mira found new friends, and they as if by chance just simply forgot about me."
...
translate english ts_scenario_0_af037056:
    ...
    nvlbazar "{font=[prologue_font]}So I still felt very lonely inside."
...
translate english ts_scenario_0_26a89f9e:
    ...
    nvlbazar "{font=[prologue_font]}But then... {i}she{/i} turned up to school."
...
translate english ts_scenario_0_3ecbe2cf:
    ...
    nvlbazar "{font=[prologue_font]}Her name was Kaori, and she was close to complete opposite of me."
...
translate english ts_scenario_0_ea6f60bb:
    ...
    nvlbazar "{font=[prologue_font]}I was a calm girl."
...
translate english ts_scenario_0_cf8f8aa7:
    ...
    nvlbazar "{font=[prologue_font]}Kaori was a restless one."
...
translate english ts_scenario_0_6d71219d:
    ...
    nvlbazar "{font=[prologue_font]}I was that kind of girl for whom you've got to do something valuable to befriend me."
...
translate english ts_scenario_0_1b744d37:
    ...
    nvlbazar "{font=[prologue_font]}Kaori thought that everyone who spent five minutes with her, now was her friend."
...
translate english ts_scenario_0_a559e7cd:
    ...
    nvlbazar "{font=[prologue_font]}I was (and still is) an A-grade student."
...
translate english ts_scenario_0_36be5895:
    ...
    nvlbazar "{font=[prologue_font]}Kaori was a C-grade student at best, struggling with almost every single subject."
...
translate english ts_scenario_0_834a1271:
    ...
    nvlbazar "{font=[prologue_font]}Kaori was a very open-minded person."
...
translate english ts_scenario_0_b5503312:
    ...
    nvlbazar "{font=[prologue_font]}I, on the other hand, tried hard to hide from anyone."
...
translate english ts_scenario_0_827ff326:
    ...
    nvlbazar "{font=[prologue_font]}But, as it happens in all kinds of stories, bipolar opposites attract."
...
translate english ts_scenario_0_f6e2ec22:
    ...
    nvlbazar "{font=[prologue_font]}We did literally everything together, and helped each other as much as we could."
...
translate english ts_scenario_0_01ab0b26:
    ...
    nvlbazar "{font=[prologue_font]}We ate together, played together, frequently visited each other..."
...
translate english ts_scenario_0_4ddfe1e9:
    ...
    nvlbazar "{font=[prologue_font]}We even skipped school together, even though that was like once or twice."
...
translate english ts_scenario_0_6d58c752:
    ...
    nvlbazar "{font=[prologue_font]}Take my word for it."
...
translate english ts_scenario_0_f833affb:
    ...
    nvlbazar "{font=[prologue_font]}The only thing we didn't do together was sleeping together."
...
translate english ts_scenario_0_f2f0e3ee:
    ...
    nvlbazar "{font=[prologue_font]}My parents treated Kaori well, and, in turn, Kaori's mom treated me well too."
...
translate english ts_scenario_0_c51ce2ce:
    ...
    nvlbazar "{font=[prologue_font]}You may ask: 'What, only mom? Dad didn't treat you well or what?'"
...
translate english ts_scenario_0_9a059317:
    ...
    nvlbazar "{font=[prologue_font]}But, the thing is... Kaori had no father, she was raised only by her mother."
...
translate english ts_scenario_0_54f7dd88:
    ...
    nvlbazar "{font=[prologue_font]}And as if Kaori herself wasn't enough, she was deaf-mute as well."
...
translate english ts_scenario_0_b234d631:
    ...
    nvlbazar "{font=[prologue_font]}Or, well, not completely, she did produce some humming sounds..."
...
translate english ts_scenario_0_c652f547:
    ...
    nvlbazar "{font=[prologue_font]}Like, you know... like a person who fell into a freezing cold water."
...
translate english ts_scenario_0_c0a6b1a8:
    ...
    nvlbazar "{font=[prologue_font]}I don't know exactly what this complication is called, and I don't even want to, but it's basically that."
...
translate english ts_scenario_0_cdfb5ad5:
    ...
    nvlbazar "{font=[prologue_font]}Anyway, Kaori successfully talked to mom via sign language. I, in turn, just wrote her, because I don't know sign language, and she just answered me back."
...
translate english ts_scenario_0_1371c2fb:
    ...
    nvlbazar "{font=[prologue_font]}So, I had one {i}real{/i} childhood friend after all."
...
translate english ts_scenario_0_d5f2e622:
    ...
    nvlbazar "{font=[adv_font]}Yay, now that's an achievement, you've got someone who cares about you."
...
translate english ts_scenario_0_af24de7e:
    ...
    nvlbazar "{font=[prologue_font]}Oh yeah, almost forgot to introduce you."
...
translate english ts_scenario_0_02b4b8de:
    ...
    nvlbazar "{font=[prologue_font]}Actually, {i}introduce{/i} seems like not the correct word..."
...
translate english ts_scenario_0_f7bb4491:
    ...
    nvlbazar "{font=[prologue_font]}But ever since childhood I had intrusive thoughts."
...
translate english ts_scenario_0_7e4c33de:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Thoughts about that I'm a complete mediocrity."
...
translate english ts_scenario_0_6c0ea620:
    ...
    nvlbazar "{font=[prologue_font]}Thoughts about that if I don't succeed a lot first try, then I won't need it after all."
...
translate english ts_scenario_0_5d8646d4:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}As the time goes, these thoughts have been more and more intrusive, and sometimes displaced my own mind."
...
translate english ts_scenario_0_57eb0362:
    ...
    nvlbazar "{font=[adv_font]}And sometimes it's even for the better. Just recall how you overcame yourself and got a summer job as a lifeguard last year./"
...
translate english ts_scenario_0_1a5b61aa:
    ...
    nvlbazar "{font=[adv_font]}If it wasn't for me, you wouldn't even try and instead would sit in one place all summer."
...
translate english ts_scenario_0_2ce475d0:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Yeah, we're not talking about summer job though, I'm talking about life. So {i}please{/i}, don't bug me."
...
translate english ts_scenario_0_27e4ac8c:
    ...
    nvlbazar "{font=[prologue_font]}Why i {b}had{/b} a childhood friend? Well, that's because after all those years of pure and sincere friendship Kaori was transferred to another school. And I was lonely all over again."
...
translate english ts_scenario_0_8703a724:
    ...
    nvlbazar "{font=[prologue_font]}It was Kaori's Granma who 'tried hard'."
...
translate english ts_scenario_0_3caf9499:
    ...
    nvlbazar "{font=[prologue_font]}Doesn't matter that I was so against it, and even my parents thought that this was completely illogical, you can't oppose a family."
...
translate english ts_scenario_0_f5a8de7c:
    ...
    nvlbazar "{font=[prologue_font]}Especially against such an assertive family member like Kaori's Granma."
...
translate english ts_scenario_0_8f4539fa:
    ...
    nvlbazar "{font=[prologue_font]}So I became one on one against this cruel world."
...
translate english ts_scenario_0_b6cdfc9f:
    ...
    nvlbazar "{font=[prologue_font]}All alone. And I've got no more friends, no more boyfriends, no one and nothing that could've filled this emptiness."
...
translate english ts_scenario_0_9a811f9c:
    ...
    nvlbazar "{font=[prologue_font]}And during the years that seemed everlasting, I didn't even think once about finding any new real friends."
...
translate english ts_scenario_0_b2b527dc:
    ...
    nvlbazar "{font=[prologue_font]}I had some acquaintances, even good ones, but I can't even bring myself to call them friends."
...
translate english ts_scenario_0_166b0a21:
    ...
    nvlbazar "{font=[prologue_font]}But we went too far already. Let's just roll back to the past for now."
...
translate english ts_scenario_0_94d010e0:
    ...
    nvlbazar "{font=[prologue_font]}Parents always demanded from me to try harder. To get better. To {i}be{/i} better."
...
translate english ts_scenario_0_591b0731:
    ...
    nvlbazar "{font=[prologue_font]}Every time that I got a C, or even B, even though it was a rare occurrence, dad would no less than unleash hell."
...
translate english ts_scenario_0_e75531fd:
    ...
    nvlbazar "{font=[prologue_font]}And it was very good if he limited himself by saying that I, according to him, was a 'frigging F-grader'."
...
translate english ts_scenario_0_3055a40c:
    ...
    nvlbazar "{font=[prologue_font]}But for the most part parents just scolded me and read all the morals, and it's dragging for at least a couple of hours."
...
translate english ts_scenario_0_7d3a1321:
    ...
    nvlbazar "{font=[prologue_font]}And if they're drunk, then, as the saying goes, {b}I'm screwed{/b}."

# game/mod_assets/scripts/scenario/text/prologue/ts_scenario.rpy:307
translate english ts_scenario_0_1e8e058b:

    # nvl clear
    # nvlbazar "{font=[prologue_font]}Нет, мои родители не алкоголики, напротив, они выпивают не так уж и часто, они добрейшей души люди, и очень часто меня поддерживают, если я пробую что-то новое."
    nvl clear
    nvlbazar "{font=[prologue_font]}My parents aren't alcoholics, quite the contrary, they drink not that often, they're nicest people ever and often support me when I try something new."
...
translate english ts_scenario_0_9b62df50:
    ...
    nvlbazar "{font=[prologue_font]}But when it came to the studying topic, and when when I wasn't a perfect girl in their eyes, they blew the thing out of every possible proportion."
...
translate english ts_scenario_0_4e7b5962:
    ...
    nvlbazar "{font=[prologue_font]}And often they just repeat themselves in their 'morals'."
...
translate english ts_scenario_0_d30f613b:
    ...
    nvlbazar "{font=[prologue_font]}I, in turn, even though was a diligent student and still am an A-grader, in fact was the laziest person in the world."
...
translate english ts_scenario_0_741973ab:
    ...
    nvlbazar "{font=[prologue_font]}Plus, I was dragged to those clubs I had nothing against."
...
translate english ts_scenario_0_57aa419c:
    ...
    nvlbazar "{font=[prologue_font]}First it was the Book Club."
...
translate english ts_scenario_0_377aeac0:
    ...
    nvlbazar "{font=[prologue_font]}I read a lot during my childhood years so teachers thought that, logically, Book Club would be a good fit."
...
translate english ts_scenario_0_f3a0842a:
    ...
    nvlbazar "{font=[prologue_font]}And that's despite the fact that over the years I was reading much less, and I had head my last book the year before I was joined to the Book Club."
...
translate english ts_scenario_0_3dcb192c:
    ...
    nvlbazar "{font=[prologue_font]}When the dad persuaded me to read 'Count of Monte-Cristo' when I was eleven, I lost any desire to read anything."
...
translate english ts_scenario_0_7501c391:
    ...
    nvlbazar "{font=[prologue_font]}Next year I was sent to Music Club. And at first I really liked it."
...
translate english ts_scenario_0_7f698b26:
    ...
    nvlbazar "{font=[prologue_font]}My Grandad had a piano and, when I was a kid, I randomly hit some keys from time to time. So when it was time for me to pick an instrument, without hesitation I pointed at piano."
...
translate english ts_scenario_0_caeb455c:
    ...
    nvlbazar "{font=[prologue_font]}But that wasn't important after all."
...
translate english ts_scenario_0_f07343c7:
    ...
    nvlbazar "{font=[prologue_font]}I liked it."
...
translate english ts_scenario_0_dddb1bdb:
    ...
    nvlbazar "{font=[prologue_font]}I quickly learned how to play a few simple songs."
...
translate english ts_scenario_0_829458c3:
    ...
    nvlbazar "{font=[prologue_font]}But... Remember how I said that I'm the laziest person in the world?"
...
translate english ts_scenario_0_d72e3c4f:
    ...
    nvlbazar "{font=[prologue_font]}Well... Maybe it's just laziness, or maybe it's a more serious disorder, but as soon as Club moved to more complex compositions, I went all lazy."
...
translate english ts_scenario_0_634f1cd6:
    ...
    nvlbazar "{font=[prologue_font]}And it's not like I didn't want to learn, or couldn't – try hard enough and you'll succeed."
...
translate english ts_scenario_0_91720433:
    ...
    nvlbazar "{font=[prologue_font]}I was just lazy."
...
translate english ts_scenario_0_b5fab559:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}And so, instead of developing as a musician, I played the same five or so songs that we learned at first couple of meetings."
...
translate english ts_scenario_0_5413d20a:
    ...
    nvlbazar "{font=[prologue_font]}And when I was given a hint that the club plays more complex compositions, and that it's time for me to improve so that I won't be the weakest link, I just chuckled and left myself."
...
translate english ts_scenario_0_a53d5e0c:
    ...
    nvlbazar "{font=[prologue_font]}So, even though technically I still can play the piano, in fact I play the piano as if I never even touched it."
...
translate english ts_scenario_0_da0682fa:
    ...
    nvlbazar "{font=[prologue_font]}Especially when you take into account that it was several years ago."
...
translate english ts_scenario_0_b0b55312:
    ...
    nvlbazar "{font=[prologue_font]}And when you're so young, it seems like those several years were like in a totally different life."
...
translate english ts_scenario_0_25846a97:
    ...
    nvlbazar "{font=[prologue_font]}After Music Club adventures I was keen into sports."
...
translate english ts_scenario_0_0ee4e98d:
    ...
    nvlbazar "{font=[prologue_font]}I didn't play hockey and other primarily male sports in which you need brute force, not some sophistications."
...
translate english ts_scenario_0_29704100:
    ...
    nvlbazar "{font=[prologue_font]}I'm a girl after all, not some kind of seven feet bull..."
...
translate english ts_scenario_0_283d3933:
    ...
    nvlbazar "{font=[prologue_font]}But our P.E. teacher let slip that soon we'll have a volleyball student competition in our town."
...
translate english ts_scenario_0_aee7fd73:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}At that competition all the other schools just stomped us, but dad always said that I played the best of all in our team."
...
translate english ts_scenario_0_0314fffa:
    ...
    nvlbazar "{font=[prologue_font]}Maybe he was biased. Maybe it was exactly like that. That's not important at the end of the day."
...
translate english ts_scenario_0_1a7e623a:
    ...
    nvlbazar "{font=[prologue_font]}Besides, I've been playing ping-pong for several years, and regularly went to ping-pong city competitions."
...
translate english ts_scenario_0_6606f2b0:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}And finally, when I was a kid, dad taught me how to play chess."
...
translate english ts_scenario_0_a8af3d59:
    ...
    nvlbazar "{font=[prologue_font]}But, just like in any kind of sport, I wasn't that strong in chess either."
...
translate english ts_scenario_0_cab55c79:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Over the years I started winning over my dad, over his friends, over all my few friends, just some random people..."
...
translate english ts_scenario_0_119ae1b3:
    ...
    nvlbazar "{font=[prologue_font]}But I'm still too far from the point where I play chess for money and make a living from a chess career."
...
translate english ts_scenario_0_da93b2ba:
    ...
    nvlbazar "{font=[prologue_font]}Maybe it's aforementioned laziness..."
...
translate english ts_scenario_0_a1c0b881:
    ...
    nvlbazar "{font=[prologue_font]}Or maybe... No, it can't be, that's only because I'm lazy."
...
translate english ts_scenario_0_3012678a:
    ...
    nvlbazar "{font=[prologue_font]}Because dad said that 'you try hard enough and you succeed'."
...
translate english ts_scenario_0_5ded3ecc:
    ...
    nvlbazar "{font=[prologue_font]}And if you don't, that only means that you don't try hard enough."
...
translate english ts_scenario_0_2b1c8f21:
    ...
    nvlbazar "{font=[prologue_font]}Getting into argument with dad was pointless, because dad is so smart, and wise, and..."
...
translate english ts_scenario_0_d9523ce4:
    ...
    nvlbazar "{font=[prologue_font]}While I... am just a small lazybones, and even though God gifted me with all kinds of talents, I successfully buried them all."
...
translate english ts_scenario_0_996bcbe1:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Other people think that I can do a lot."
...
translate english ts_scenario_0_63469a55:
    ...
    nvlbazar "{font=[prologue_font]}Looks can be deceiving though. I know that even though I can do a lot of stuff, I'm mediocre at all of it at best."
...
translate english ts_scenario_0_b51d829e:
    ...
    nvlbazar "{font=[prologue_font]}I know that I'm a lazybones and total mediocrity."
...
translate english ts_scenario_0_4353d8c2:
    ...
    nvlbazar "{font=[prologue_font]}Other people think that I'm a jack of all trades."
...
translate english ts_scenario_0_185290ad:
    ...
    nvlbazar "{font=[prologue_font]}I know that yes, I am, but I am still a master of none..."
...
translate english ts_scenario_0_ace0898f:
    ...
    nvlbazar "{font=[prologue_font]}Last year I was transferred to another class."
...
translate english ts_scenario_0_d31e80ab:
    ...
    nvlbazar "{font=[prologue_font]}All those people seemed completely unfamiliar to me. However, aside from Kaori, no one talked to me in my previous class either."
...
translate english ts_scenario_0_48d94424:
    ...
    nvlbazar "{font=[prologue_font]}But Kaori was transferred to another school. So I was all alone before, and I am still all alone now."
...
translate english ts_scenario_0_4cbf94b1:
    ...
    nvlbazar "{font=[prologue_font]}Actually, there was one guy... Mitsuo, I guess?"
...
translate english ts_scenario_0_22a7139b:
    ...
    nvlbazar "{font=[prologue_font]}But, considering my 'school pride' status, he was afraid to even talk to me due to his overall shyness."
...
translate english ts_scenario_0_21fffc31:
    ...
    nvlbazar "{font=[prologue_font]}Throughout the entire year I didn't hear from him a single sentence, a single question, not even a single word."
...
translate english ts_scenario_0_705237fa:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Well, doesn't matter. I still had a class full of unfamiliar people."
...
translate english ts_scenario_0_036de800:
    ...
    nvlbazar "{font=[prologue_font]}One unfamiliar person more, one less... What's the difference?"
...
translate english ts_scenario_0_b7384295:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}I joined the Debate Club the same year."
...
translate english ts_scenario_0_054c1960:
    ...
    nvlbazar "{font=[prologue_font]}At the same time the club itself was growing bigger. Even bigger than I could want."
...
translate english ts_scenario_0_a3308a5a:
    ...
    nvlbazar "{font=[prologue_font]}And the debates itself quickly went monotonous."
...
translate english ts_scenario_0_395b632d:
    ...
    nvlbazar "{font=[prologue_font]}If we had debates about literally anything before, then the only things we argued about were about budget and publicity and how to prepare for the events."
...
translate english ts_scenario_0_13bfb21b:
    ...
    nvl clear
    nvlbazar "{font=[prologue_font]}Eventually all that politics of a major club was getting bigger than me, up until the moment when I couldn't oppose it."
...
translate english ts_scenario_0_7c757336:
    ...
    nvlbazar "{font=[prologue_font]}So I just asked to resign me from the post, and moved on with my life, leaving all those major club politics for someone else."
...
translate english ts_scenario_0_4ebb5e5d:
    ...
    nvlbazar "{font=[prologue_font]}Let others deal with all that. Not me."
...
translate english ts_scenario_0_722b311e:
    ...
    nvlbazar "{font=[prologue_font]}I want my club so that there won't be a word 'incorrect'."
...
translate english ts_scenario_0_dfffeb5e:
    ...
    nvlbazar "{font=[prologue_font]}I want my club so that everyone could express oneself as open as one wishes."
...
translate english ts_scenario_0_a1ce20b1:
    ...
    nvlbazar "{font=[prologue_font]}I want my club so that we share something personal, something intimate."
...
translate english ts_scenario_0_2a32460f:
    ...
    nvlbazar "{font=[prologue_font]}And then it dawned on me. I know exactly what kind of club I want to open."
...
translate english ts_scenario_0_55a4a6db:
    ...
    nvlbazar "{font=[prologue_font]}The Literature Club."
