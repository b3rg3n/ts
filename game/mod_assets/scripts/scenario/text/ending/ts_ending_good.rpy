label ts_good_ending_blya:
    ...
    ts_ft 1z "Но мы с тобой всего одну ночь не виделись, с чего вдруг такие телячьи нежности?"
    ...
    m "О, насчёт этого не переживайте - один человек {b}точно{/b} придёт. Папа мой."
    ...
    "Конечно, папа слегка расстроился, что мы так никого и не добрали, но лично я уже привыкла к трём девочкам, и не особо уже хочу добирать ещё кого-то."
    "А это всё, что важно..."
    ...
    m "Какая вообще разница, ребята мы, девчата, или кто-то ещё? Главное, что мы вместе сейчас, и будем вместе всю оставшуюся жизнь."
    show yuri 2j at t31
    show sayori 3l at t32
    show natsuki 2t at t33
...
#om smile/oe ida, cm/oe moni
    ...
    ts_mt "Он очень странно на меня посмотрел, но желание исполнил. И вот, час в пути, и я уже здесь."
...
#cm/oe ida, om smile/oe moni
    ...
    "На скорую руку она за пятнадцать минут приготовила жареную картошку и какой-то простенький салатик."
    show minami 2bn at f21
    show hiroto 1a at t22
