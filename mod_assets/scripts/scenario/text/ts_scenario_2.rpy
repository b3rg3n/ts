label ts_scenario_2:
    ...
    "Я только вчера легла в кровать в пятницу, а сейчас уже утро понедельника."
    ...
    "И как будто специально, как только я об этом подумала, как Сайори ещё раз буквально вваливается в кабинет Литературного клуба."
    ...
    "Как вдруг, наконец, в дверь постучали."
    ...
    "У неё спина не болит такие бидоны постоянно таскать?"
    ...
    $ text21 = "Посмотрим, как она «обрадуется» следующим заданиям от Юри." #И ЭТО ТОЖЕ
    $ text22 = "Это ведь {b}далеко{/b} не самая сложная книга в мире." #И ВОТ ЭТО
    ...
    "Правда, ни одно из этих увлечений долго не продолжалось..."
    ...
    "Психически нездоровый человек. Впрочем, а {i}я{/i} когда-нибудь была психически здоровой?"
...
#ТУТ БУДЕТ ЦГШКА (ЭТИМ ЗАНИМАТЬСЯ БУДЕМ НЕ МЫ, А СПЕЦИАЛЬНЫЙ ЧЕЛОВЕЧЕК, ЕСЛИ ЧТО)
    ...
    y 1x "П-после этого случая... мой внутренний голос твердил мне, что так мне и нужно."
    ...
    "Отстань уже, не видишь, девочка только плакать перестала, а ты опять нагнетаешь."
    "Так вот..."
    ...
    y 2o "Очень с-серьёзная... менструация..."
