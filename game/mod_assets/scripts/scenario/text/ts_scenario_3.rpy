label ts_scenario_3:
    ...
    "Наконец-то, перемена..."
    "После третьего урока перемена побольше, чтобы все успели перекусить, потому что день предстоит долгий..."
    ...
    "Куда делось «в своём клубе я не хочу, чтобы было слово неправильно»?"
    ...
    s 2l "М-Моника?.. Ты уже пять минут пялишься в одну точку и даже не двигаешься..."
    m "Ой... Прости..."
    ...
    n 12f "Но... Папа считает, что я ещё недостаточно взрослая и самостоятельная, чтобы самой вправе что-то решать."
    ...
    "«Впрочем, я же и так её не особо одобряю...»"
    ...
    if unluck3 == True:
        ...
        "И поскольку гарнир уже, по сути, готов, теперь нужно будет придумать основное блюдо."
    ...
    "Ни я, ни папа не пьём свои горячительные напитки с сахаром."
    ...
    n 12f "Папа считает, что я ещё недостаточно взрослая и самостоятельная, чтобы самой вправе что-то решать."
    n 12c "И ведь с ним не поспоришь даже! Он же папа, он же взрослый, умный, а я что?"
    n 12f "Всего лишь маленькая девочка..."
    ...
    ts_ft 2g "Что это на тебя сегодня нахлынуло?.."
