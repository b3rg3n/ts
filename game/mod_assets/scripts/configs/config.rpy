...
define config.intra_transition = ImageDissolve(ts_anim + "transit/pixel_2.webp", 0.15, alpha = True)#ImageDissolve(im.Tile("mod_assets/source/images/anim/transit/pattern.webp"), 0.4, 1)
