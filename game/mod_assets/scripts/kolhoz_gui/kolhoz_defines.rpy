...
init -4 python:
    ...
    if _preferences.language == "english":
        ...
        layout.FAST_SKIP_UNSEEN = "Промотать всё до следующего выбора?"
        layout.FAST_SKIP_SEEN = "Перейти на следующий выбор?"
